...
function (generate_kurento_libraries)
  ...
  string (REPLACE "${CMAKE_BINARY_DIR}/" "build/" _INTERFACE_HEADERS_DIR ${GEN_FILES_DIR})
  ...
  string (REPLACE "${CMAKE_BINARY_DIR}/" "build/" _SERVER_INTERNAL_GENERATED_HEADERS_DIR ${SERVER_INTERNAL_GEN_FILES_DIR})
  ...
  string (REPLACE "${CMAKE_BINARY_DIR}/" "build/" _PARAM_SERVER_STUB_DESTINATION ${PARAM_SERVER_STUB_DESTINATION})
