...
SdpMessageContext *kms_sdp_context_new_message_context (SdpIPv ipv, GError **error);
gboolean kms_sdp_context_set_common_session_attributes (SdpMessageContext *ctx, const GstSDPMessage *msg, GError **error);
...
GstSDPMessage * sdp_mesage_context_pack (SdpMessageContext *ctx, GError **error);
