...
#define KMS_FILTER_ELEMENT(obj)   (G_TYPE_CHECK_INSTANCE_CAST((obj),KMS_TYPE_FILTER_ELEMENT,KmsFilterElement))
#define KMS_FILTER_ELEMENT_CLASS(klass)   (G_TYPE_CHECK_CLASS_CAST((klass),KMS_TYPE_FILTER_ELEMENT,KmsFilterElementClass))
#define KMS_IS_FILTER_ELEMENT(obj)   (G_TYPE_CHECK_INSTANCE_TYPE((obj),KMS_TYPE_FILTER_ELEMENT))
#define KMS_IS_FILTER_ELEMENT_CLASS(obj)   (G_TYPE_CHECK_CLASS_TYPE((klass),KMS_TYPE_FILTER_ELEMENT))
